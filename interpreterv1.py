...
class Interpreter(InterpreterBase):
	...
	def do_func_call(self, statement_node: Element) -> Any:
		...
		"""
		evaluated_args = list(map(self.evaluate_expression, statement_node.get("args")))
		match statement_node.get("name"):
			...
			case other:
				super().error(ErrorType.NAME_ERROR, f"Unknown function call: '{other}'")
	...
	def get_value_of_variable(self, variable_node: Element):
	...
	def get_value(self, value_node: Element):
		return value_node.get("val")
	
	def evaluate_binary_operator(self, expression_node: Element):
		"""
